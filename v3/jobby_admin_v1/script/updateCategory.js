...
async function updateCategory () {
  let responsePFEnv
  try {
    responsePFEnv = await fetch('http://jobby:11000/updateCategory', {
      method: 'POST',
      headers: {
  ...
  if (responsePF.messageError === false) {
    ...
    document.location.href = 'http://jobby:5500/jobby_admin_v1/views/categories.html'
    let blockMessage = document.querySelector('#message')
...
//            let responsePFEnv
//            try{
//                 responsePFEnv = await fetch ("http://jobby:11000/categorie", {
//                    method: 'POST',
//                    headers: {
//                        'Accept': 'application/json',
//                        'Content-Type': 'application/json',
