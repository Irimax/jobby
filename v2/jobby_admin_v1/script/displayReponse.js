...
async function displayReponse () {
  ...
  const myApiUrl = 'http://jobby:6015/reponse/idreponse/' + searchParams.get('reponseId')
  ...
  document.querySelector('form.container input[name=reponseId]').value = searchParams.get('reponseId')
